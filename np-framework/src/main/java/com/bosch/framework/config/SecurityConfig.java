...
import com.bosch.framework.config.properties.PermitAllUrlProperties;
import com.bosch.framework.security.filter.JwtAuthenticationTokenFilter;
import com.bosch.framework.security.handle.AuthenticationEntryPointImpl;
import com.bosch.framework.security.handle.LogoutSuccessHandlerImpl;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter
{
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception
    {
        ...
        httpSecurity
                ...
                .antMatchers("/honey/verify/upload64").permitAll()
