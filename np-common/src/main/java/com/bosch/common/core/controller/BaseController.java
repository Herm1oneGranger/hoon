package com.bosch.common.core.controller;

import com.bosch.common.constant.HttpStatus;
...
import com.bosch.common.core.page.TableSupport;
import com.bosch.common.utils.DateUtils;
import com.bosch.common.utils.PageUtils;
import com.bosch.common.utils.SecurityUtils;
import com.bosch.common.utils.StringUtils;
import com.bosch.common.utils.sql.SqlUtil;
...
public class BaseController
{
     ...
     */
    @SuppressWarnings({ "rawtypes", "unchecked" })
    protected TableDataInfo getDataTable(List<?> rawList, List<?> targetList)
    {
        TableDataInfo rspData = new TableDataInfo();
        rspData.setCode(HttpStatus.SUCCESS);
        rspData.setMsg("查询成功");
